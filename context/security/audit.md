...
- Auth/security: `AUTH_LOGIN_SUCCESS`, `AUTH_LOGIN_FAILED`, `AUTH_FORCE_LOGOUT_OTHERS`, `AUTH_SESSION_REVOKED`, `AUTH_REFRESH_SUCCESS`, `AUTH_REFRESH_FAILED`, `AUTH_LOGOUT`, `AUTH_PASSWORD_RESET_REQUESTED`, `AUTH_PASSWORD_RESET_SUCCESS`, `AUTH_PASSWORD_CHANGED`, `API_RATE_LIMIT_CHECK`.
