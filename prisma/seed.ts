...
async function main() {
  ...
  const employeeSeeds = [
    ...
    { id: "seed_emp_8", email: "hendra.wijaya@rsudbahteramas.test", role: Role.EMPLOYEE, name: "Hendra Wijaya, S.Kep", employeeId: "199401152019031002", nik: "7471111501940002", gender: "Laki-laki", birthPlace: "Raha", birthDate: dateOnly(1994, 1, 15), degree: "S.Kep", education: "S1 Keperawatan", status: asn, group: pppkGroup, position: positions[2], rank: ranks[2], workplace: workplaces[0] },
    { id: "seed_emp_9", email: "riana.lestari@rsudbahteramas.test", role: Role.EMPLOYEE, name: "Riana Lestari, A.Md.Far", employeeId: null, nik: "7471122212970003", gender: "Perempuan", birthPlace: "Kolaka", birthDate: dateOnly(1997, 12, 22), degree: "A.Md.Far", education: "D3 Farmasi", status: nonAsn, group: bludKontrakGroup, position: positions[5], rank: ranks[0], workplace: workplaces[4] },
    { id: "seed_emp_10", email: "agus.subekti@rsudbahteramas.test", role: Role.EMPLOYEE, name: "Agus Subekti, S.Kom", employeeId: "198708172015031005", nik: "7471131708870005", gender: "Laki-laki", birthPlace: "Kendari", birthDate: dateOnly(1987, 8, 17), degree: "S.Kom", education: "S1 Teknik Informatika", status: asn, group: pnsGroup, position: positions[7], rank: ranks[3], workplace: workplaces[6] },
    { id: "seed_emp_11", email: "yuni.kartika@rsudbahteramas.test", role: Role.EMPLOYEE, name: "Yuni Kartika, A.Md.Keb", employeeId: null, nik: "7471141406980006", gender: "Perempuan", birthPlace: "Bau-Bau", birthDate: dateOnly(1998, 6, 14), degree: "A.Md.Keb", education: "D3 Kebidanan", status: nonAsn, group: bludTetapGroup, position: positions[4], rank: ranks[0], workplace: workplaces[2] },
    { id: "seed_emp_12", email: "ahmad.dani@rsudbahteramas.test", role: Role.EMPLOYEE, name: "Ahmad Dani, S.Kep.Ns", employeeId: "199202112018011003", nik: "7471151102920004", gender: "Laki-laki", birthPlace: "Unaaha", birthDate: dateOnly(1992, 2, 11), degree: "S.Kep.Ns", education: "Profesi Ners", status: asn, group: pppkGroup, position: positions[3], rank: ranks[2], workplace: workplaces[1] },
    { id: "seed_emp_13", email: "siti.aminah@rsudbahteramas.test", role: Role.EMPLOYEE, name: "Siti Aminah, A.Md.Rad", employeeId: "199511112020122008", nik: "7471161111950005", gender: "Perempuan", birthPlace: "Kendari", birthDate: dateOnly(1995, 11, 11), degree: "A.Md.Rad", education: "D3 Radiologi", status: asn, group: pnsGroup, position: positions[6], rank: ranks[3], workplace: workplaces[5] },
    { id: "seed_emp_14", email: "tony.sucipto@rsudbahteramas.test", role: Role.EMPLOYEE, name: "Tony Sucipto, S.Ked", employeeId: null, nik: "7471172504960007", gender: "Laki-laki", birthPlace: "Kolaka", birthDate: dateOnly(1996, 4, 25), degree: "S.Ked", education: "Pendidikan Dokter", status: nonAsn, group: bludKontrakGroup, position: positions[0], rank: ranks[0], workplace: workplaces[3] },
    { id: "seed_emp_15", email: "dian.pratiwi@rsudbahteramas.test", role: Role.EMPLOYEE, name: "Dian Pratiwi, S.Tr.Keb", employeeId: "199009092017042006", nik: "7471180909900009", gender: "Perempuan", birthPlace: "Raha", birthDate: dateOnly(1990, 9, 9), degree: "S.Tr.Keb", education: "D4 Kebidanan", status: asn, group: pnsGroup, position: positions[4], rank: ranks[4], workplace: workplaces[2] },
    { id: "seed_emp_16", email: "bambang.heryanto@rsudbahteramas.test", role: Role.EMPLOYEE, name: "Bambang Heryanto, M.Kep", employeeId: "198305052009121001", nik: "7471190505830001", gender: "Laki-laki", birthPlace: "Bau-Bau", birthDate: dateOnly(1983, 5, 5), degree: "M.Kep", education: "S2 Keperawatan", status: asn, group: pnsGroup, position: positions[1], rank: ranks[5], workplace: workplaces[6] },
    { id: "seed_emp_17", email: "megawati.soekarno@rsudbahteramas.test", role: Role.EMPLOYEE, name: "Megawati, S.Psi", employeeId: null, nik: "7471201212970002", gender: "Perempuan", birthPlace: "Kendari", birthDate: dateOnly(1997, 12, 12), degree: "S.Psi", education: "S1 Psikologi", status: nonAsn, group: bludKontrakGroup, position: positions[7], rank: ranks[0], workplace: workplaces[6] },
  ];
